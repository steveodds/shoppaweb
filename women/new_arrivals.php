...
<body>
    ...
    <ul>
        ...
        <li class="dropdown">
            ...
            <div class="dropdown-content">
                <a class="active" href="../women/new_arrivals.php">New Arrivals</a>
    ...
    <SECTION>
        <h1 class="lol" align="center">WOMEN'S NEW ARRIVALS</h1>
        <section>
            <img src="../img/women_new-1.jpg" class="women-NEW">
            <img src="../img/women_new-2.jpg" class="women-NEW">
            <img src="../img/women_new-3.jpg" class="women-NEW">
        </section>
    </SECTION>
