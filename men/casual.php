...
?>
    ...
    <body>
        <ul>
            ...
            <li class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <a class="active" href="../men/casual.php">Casual</a>
        ...
        <SECTION>
            <h1 class="lol" align="center">MEN'S CASUAL PRODUCTS</h1>

            <div id="gridview">
                <?php
                $query = $db_handle->runQuery("SELECT * FROM products WHERE target='Men' AND category='Casual' ORDER BY id ASC");
                if (!empty($query)) {
