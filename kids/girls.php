...
?>
  ...
  <body>
    ...
    <ul>
      ...
      <li class="dropdown">
        ...
        <div class="dropdown-content">
          ...
          <a class="active" href="../kids/girls.php">Girls</a>
        </div>
      </li>
    ...
    <SECTION>
      <h1 class="lol" align="center">KIDS' (GIRLS) PRODUCTS</h1>
      <div id="gridview">
        <?php
        $query = $db_handle->runQuery("SELECT * FROM products WHERE target='Kids' AND category='Girls' ORDER BY id ASC");
        if (!empty($query)) {
