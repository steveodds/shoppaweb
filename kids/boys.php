  ...
  <body>
    ...
    <ul>
      ...
      <li class="dropdown">
        ...
        <div class="dropdown-content">
          <a class="active" href="../kids/boys.php">Boys</a>
    ...
    <SECTION>
      <h1 class="lol" align="center">KIDS' (BOYS) PRODUCTS</h1>
      <div id="gridview">
        <?php
        $query = $db_handle->runQuery("SELECT * FROM products WHERE target='Kids' AND category='Boys' ORDER BY id ASC");
        if (!empty($query)) {
